      ...
      <Container maxWidth="sm">
        <Box sx={{ mt: 4, textAlign: "center" }}>
          <form onSubmit={handleFormSubmit}>
            ...
            <TextField label="Email" variant="outlined" margin="normal" fullWidth value={etudiant.email} onChange={(e) => setEtudiant({ ...etudiant, email: e.target.value })} required />
            ...
            <TextField label="CIN" variant="outlined" margin="normal" fullWidth value={
person2.cin} onChange={(e) => setPerson2({ ...person2, cin: e.target.value })} />
